...
export class PaymentsModule {
   ...
   */
  async create(_goid: string, _params: PaymentCreateRequest): Promise<PaymentCreateResponse> {
   ...
   */
  async charge(_paymentId: string, _params: PaymentChargeRequest): Promise<PaymentChargeResponse> {
    throw new Error('Not implemented');
  }
